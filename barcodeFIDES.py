...
def main_gui():
    ...
    frame = ttk.Frame(fen, padding=20)
    #frame = tk.Frame(fen, bg="#E0F1A1", padx=20, pady=20)
    frame.grid()
    ...
    def on_generate():
        try:
            ...
            ratio = ratio_default
            generate_pdf(date_inv, pages, start_number, ratio, progress_bar, status_label, fen)
